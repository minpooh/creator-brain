...
export default function Cta() {
  return (
    <section className="flex w-full flex-col items-center gap-8 bg-gradient-to-r from-[#0f172a] to-[#1e1b4b] px-5 py-16 md:gap-10 md:px-10 md:py-20 lg:gap-12 lg:px-20 lg:py-[120px]">
      ...
      <Button
        variant="primary"
        className="w-full max-w-[335px] rounded-xl bg-black px-9 py-4 hover:bg-gray-900 md:w-auto md:max-w-none"
      >
